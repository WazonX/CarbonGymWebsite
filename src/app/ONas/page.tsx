    ...
    return(
        <motion.div {...AnimationSettings} className="pt-5 pb-5 row ">
            ...
            <div className="col-8">
                ...
                alt="" src={Michal.src} className='mx-2 w-50 rounded float-start minWidthImg'/>
                <div className="separator"></div>
                <p className="mx-12 text-mid text-under-sm">
            ...
            <div className="col-8">
                ...
                className='mx-2 w-50 float-start rounded minWidthImg ' alt="" src={Zoska.src}/>
               <div className="separator"></div>
                <p className="mx-12 text-mid">
